      ...
      <div className="col-md-9 mx-auto py-4">
        ...
        <div className="form-group my-3">
          ...
          <div className="form-group my-3 ">
            ...
            <input onChange={formik.handleChange} onBlur={formik.handleBlur} type="password" className="form-control" id="rePassword" placeholder=" rePassword" />
...
/>
          ...
          <Link className="ps-5" to={'/login'} > login </Link>
        </form>
